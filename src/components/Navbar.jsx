        ...
        <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '68px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '2rem' }} className="nav-links">
            {links.map(l => (
              <a key={l.label} href={l.href}
                style={{ fontSize: '0.86rem', fontWeight: 500, color: '#374151', letterSpacing: '0.01em', transition: 'color 0.2s' }}
                className="nav-link"
              >{l.label}</a>
            ))}
          </div>
          ...
          <a href="https://wa.me/919645888250" target="_blank" rel="noreferrer"
            style={{
              ...
              padding: '0.5rem 1.1rem', borderRadius: '0px',
